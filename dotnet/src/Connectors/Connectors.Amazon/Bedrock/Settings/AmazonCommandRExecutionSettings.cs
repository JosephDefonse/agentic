...
public class AmazonCommandRExecutionSettings : PromptExecutionSettings
{
    ...
    /// <summary>
    /// The maximum number of tokens the model should generate as part of the response. Note that setting a low value may result in incomplete generations. Setting max_completion_tokens may result in incomplete or no generations when used with the tools or documents fields.
    /// </summary>
