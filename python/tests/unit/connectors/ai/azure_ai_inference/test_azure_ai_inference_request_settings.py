...
def test_azure_ai_inference_prompt_execution_settings_from_default_completion_config():
    ...
    chat_settings = (
        AzureAIInferenceChatPromptExecutionSettings.from_prompt_execution_settings(
            settings
        )
    )
    ...
    assert chat_settings.max_completion_tokens is None
...
def test_azure_ai_inference_prompt_execution_settings_from_openai_prompt_execution_settings():
    chat_settings = AzureAIInferenceChatPromptExecutionSettings(
        service_id="test_service", temperature=1.0
    )
    new_settings = AzureAIInferencePromptExecutionSettings(
