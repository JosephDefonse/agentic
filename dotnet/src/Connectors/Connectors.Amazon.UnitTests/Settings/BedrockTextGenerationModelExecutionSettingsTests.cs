...
public class BedrockTextGenerationModelExecutionSettingsTests
{
    ...
    public async Task JambaExecutionSettingsExtensionDataSetsProperlyAsync()
    {
        ...
        Assert.True(requestBodyRoot.TryGetProperty("max_completion_tokens", out var maxTokensProperty));
        Assert.Equal(executionSettings.ExtensionData.TryGetValue("max_completion_tokens", out var extensionMaxTokens) ? extensionMaxTokens : executionSettings.MaxTokens, maxTokensProperty.GetInt32());
    ...
    public async Task ClaudeExecutionSettingsSetsExtensionDataAsync()
    {
        ...
        var executionSettings = new PromptExecutionSettings()
        {
            ...
            ExtensionData = new Dictionary<string, object>()
            {
                { "temperature", 0.8 },
                { "top_p", 0.95 },
                { "max_completion_tokens_to_sample", 256 },
        ...
        Assert.True(requestBodyRoot.TryGetProperty("max_completion_tokens_to_sample", out var maxTokensToSampleProperty));
        Assert.Equal(executionSettings.ExtensionData["max_completion_tokens_to_sample"], maxTokensToSampleProperty.GetInt32());
    ...
    public async Task CommandExecutionSettingsSetsExtensionDataAsync()
    {
        ...
        Assert.True(requestBodyRoot.TryGetProperty("max_completion_tokens", out var maxTokensProperty));
        Assert.Equal(executionSettings.ExtensionData["max_completion_tokens"], maxTokensProperty.GetInt32());
