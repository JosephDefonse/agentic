...
class OpenAIPromptExecutionSettings(PromptExecutionSettings):
    ...
    number_of_responses: Annotated[
        int | None, Field(ge=1, le=128, serialization_alias="n")
    ] = None
...
class OpenAITextPromptExecutionSettings(OpenAIPromptExecutionSettings):
    ...
    prompt: Annotated[
        str | None,
        Field(
            description="Do not set this manually. It is set by the service based on the text content."
        ),
    ] = None
...
class OpenAIChatPromptExecutionSettings(OpenAIPromptExecutionSettings):
    ...
    messages: Annotated[
        ...
        Field(description="Do not set this manually. It is set by the service."),
    ] = None
