...
public class AmazonMistralExecutionSettings : PromptExecutionSettings
{
    ...
    /// <summary>
    /// Specify the maximum number of tokens to use in the generated response. The model truncates the response once the generated text exceeds max_completion_tokens
    /// </summary>
