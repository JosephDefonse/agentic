...
// ReSharper restore InconsistentNaming
{
    ...
    public object GetInvokeModelRequestBody(string modelId, string prompt, PromptExecutionSettings? executionSettings)
    {
        ...
        var requestBody = new CommandRRequest.CommandRTextGenerationRequest()
        {
            ...
            MaxTokens = BedrockModelUtilities.GetExtensionDataValue<int?>(executionSettings?.ExtensionData, "max_completion_tokens") ?? exec.MaxTokens,
    ...
    public ConverseRequest GetConverseRequest(string modelId, ChatHistory chatHistory, PromptExecutionSettings? settings)
    {
        ...
        var maxTokens = BedrockModelUtilities.GetExtensionDataValue<int?>(settings?.ExtensionData, "max_completion_tokens") ?? exec.MaxTokens;
    ...
    public ConverseStreamRequest GetConverseStreamRequest(string modelId, ChatHistory chatHistory, PromptExecutionSettings? settings)
    {
        ...
        var maxTokens = BedrockModelUtilities.GetExtensionDataValue<int?>(settings?.ExtensionData, "max_completion_tokens") ?? executionSettings.MaxTokens;
