...
def get_openai_text_completion_service_and_request_settings() -> (
    tuple["TextCompletionClientBase", "PromptExecutionSettings"]
):
    ...
    request_settings = OpenAITextPromptExecutionSettings(
        max_completion_tokens=20, temperature=0.7, top_p=0.8
    )

    return text_service, request_settings


def get_azure_openai_text_completion_service_and_request_settings() -> (
    tuple["TextCompletionClientBase", "PromptExecutionSettings"]
):
...
def get_bedrock_text_completion_service_and_request_settings() -> (
    tuple["TextCompletionClientBase", "PromptExecutionSettings"]
):
...
def get_google_ai_text_completion_service_and_request_settings() -> (
    tuple["TextCompletionClientBase", "PromptExecutionSettings"]
):
...
def get_hugging_face_text_completion_service_and_request_settings() -> (
    tuple["TextCompletionClientBase", "PromptExecutionSettings"]
):
    ...
    text_service = HuggingFaceTextCompletion(
...
def get_ollama_text_completion_service_and_request_settings() -> (
    tuple["TextCompletionClientBase", "PromptExecutionSettings"]
):
...
def get_onnx_text_completion_service_and_request_settings() -> (
    tuple["TextCompletionClientBase", "PromptExecutionSettings"]
):
...
def get_vertex_ai_text_completion_service_and_request_settings() -> (
    tuple["TextCompletionClientBase", "PromptExecutionSettings"]
):
