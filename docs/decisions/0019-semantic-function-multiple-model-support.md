...
In the example below the semantic function is executed with "AzureText" using `max_completion_tokens=60` because "AzureText" is the first service id in the list of models configured for the prompt.
...
// Semantic function is executed with AzureText using max_completion_tokens=60
