...
def get_openai_chat_completion_service_and_request_settings(
    ...
    chat_service = OpenAIChatCompletion(
        service_id=service_id, instruction_role=instruction_role
    )
    request_settings = OpenAIChatPromptExecutionSettings(
        service_id=service_id, max_completion_tokens=2000, temperature=0.7, top_p=0.8
    )
...
def get_anthropic_chat_completion_service_and_request_settings() -> (
    tuple["ChatCompletionClientBase", "PromptExecutionSettings"]
):
...
def get_bedrock_chat_completion_service_and_request_settings() -> (
    tuple["ChatCompletionClientBase", "PromptExecutionSettings"]
):
...
def get_google_ai_chat_completion_service_and_request_settings() -> (
    tuple["ChatCompletionClientBase", "PromptExecutionSettings"]
):
...
def get_mistral_ai_chat_completion_service_and_request_settings() -> (
    tuple["ChatCompletionClientBase", "PromptExecutionSettings"]
):
...
def get_ollama_chat_completion_service_and_request_settings() -> (
    tuple["ChatCompletionClientBase", "PromptExecutionSettings"]
):
...
def get_onnx_chat_completion_service_and_request_settings() -> (
    tuple["ChatCompletionClientBase", "PromptExecutionSettings"]
):
...
def get_vertex_ai_chat_completion_service_and_request_settings() -> (
    tuple["ChatCompletionClientBase", "PromptExecutionSettings"]
):
...
def get_deepseek_chat_completion_service_and_request_settings() -> (
    tuple["ChatCompletionClientBase", "PromptExecutionSettings"]
):
