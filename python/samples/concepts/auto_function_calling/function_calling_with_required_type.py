...
async def handle_streaming(
    ...
    async for message in response:
        if (
            (
                ...
                or execution_settings.function_choice_behavior.type_
            ...
            isinstance(message[0], StreamingChatMessageContent)
            and message[0].role == AuthorRole.ASSISTANT
        ):
    ...
    if streamed_chunks:
        ...
        if (
            hasattr(streaming_chat_message, "content")
            and streaming_chat_message.content
        ):
