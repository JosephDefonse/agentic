...
execution_settings = PromptExecutionSettings(
    ...
    max_completion_tokens=ConversationSummaryPlugin._max_completion_tokens,
    temperature=0.1,
    top_p=0.5,
)
...
Assistant:  """,
        ...
        execution_settings=[
            PromptExecutionSettings(
                service_id="default", temperature=0.0, max_completion_tokens=1000
            ),
            PromptExecutionSettings(
                service_id="gpt-3.5-turbo", temperature=0.2, max_completion_tokens=4000
            ),
            PromptExecutionSettings(
                service_id="gpt-4", temperature=0.3, max_completion_tokens=8000
            ),
        ],
        input_variables=[
            InputVariable(
