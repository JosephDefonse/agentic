...
chat_completion_service, request_settings = (
    get_chat_completion_service_and_request_settings(Services.AZURE_OPENAI)
)
kernel.add_service(chat_completion_service)

request_settings.max_completion_tokens = 2000
